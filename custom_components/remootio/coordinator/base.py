"""
Core DataUpdateCoordinator implementation for remootio.
...
from custom_components.remootio.api import (
    RemootioApiClientAuthenticationError,
    RemootioApiClientError,
)
from custom_components.remootio.const import LOGGER
...
class RemootioDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    async def _async_update_data(self) -> Any:
        ...
        except RemootioApiClientAuthenticationError as exception:
            LOGGER.warning("Authentication error - %s", exception)
            raise ConfigEntryAuthFailed(
                translation_domain="remootio",
                translation_key="authentication_failed",
            ) from exception
        except RemootioApiClientError as exception:
