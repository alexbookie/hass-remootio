"""
Custom integration to integrate remootio with Home Assistant.
...
https://github.com/alexbookie/hass-remootio
...
from .api import RemootioApiClient
from .const import DOMAIN, LOGGER
from .coordinator import RemootioDataUpdateCoordinator
from .data import RemootioData
from .service_actions import async_setup_services

if TYPE_CHECKING:
    from homeassistant.core import HomeAssistant

    from .data import RemootioConfigEntry
...
async def async_setup_entry(
    ...
    # Store runtime data
    entry.runtime_data = RemootioData(
        client=client,
