"""
Base entity class for remootio.
...
from custom_components.remootio.const import ATTRIBUTION
from custom_components.remootio.coordinator import RemootioDataUpdateCoordinator
...
class RemootioEntity(CoordinatorEntity[RemootioDataUpdateCoordinator]):
    """
    Base entity class for remootio.
