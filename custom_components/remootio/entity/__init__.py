"""
Entity package for remootio.

Architecture:
    All platform entities inherit from (PlatformEntity, RemootioEntity).
...
See entity/base.py for the RemootioEntity base class.
"""

from .base import RemootioEntity

__all__ = ["RemootioEntity"]
