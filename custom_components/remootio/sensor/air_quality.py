"""Air quality sensors for remootio."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.remootio.entity import RemootioEntity
...
class RemootioAirQualitySensor(SensorEntity, RemootioEntity):
