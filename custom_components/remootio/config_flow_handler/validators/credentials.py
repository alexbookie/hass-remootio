...
from custom_components.remootio.api import RemootioApiClient
...
async def validate_credentials(hass: HomeAssistant, username: str, password: str) -> None:
    ...
    Raises:
        RemootioApiClientAuthenticationError: If credentials are invalid.
        RemootioApiClientCommunicationError: If communication fails.
        RemootioApiClientError: For other API errors.
