...
- `entity/` — Base entity class (`RemootioEntity`)
...
- Entity MRO: `(PlatformEntity, RemootioEntity)` — order matters
...
- Debug level: `custom_components.remootio: debug` in `config/configuration.yaml`
