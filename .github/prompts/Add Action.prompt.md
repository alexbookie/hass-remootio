...
**File:** `custom_components/remootio/services.yaml`
...
Create `custom_components/remootio/service_actions/[action_name].py`:

```python
"""[Action name] service action for Remootio."""
...
**File:** `custom_components/remootio/__init__.py`
...
**File:** `custom_components/remootio/const.py`
...
3. Find service action: `remootio.[action_name]`
...
- **Domain:** `remootio`
- **Service actions directory:** `custom_components/remootio/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/remootio/services.yaml` (legacy filename)
- **Icons:** `custom_components/remootio/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/remootio/translations/*.json` under `services` key (legacy)
