...
- Create new sensor file in `custom_components/remootio/sensor/`
- Inherit from `RemootioEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Remootio."""
...
class Remootio[SensorName]Sensor(
    RemootioEntity,
    SensorEntity,
):
...
- Entity: `custom_components/remootio/sensor/[sensor_name].py`
- Platform: `custom_components/remootio/sensor/__init__.py`
- Translations: `custom_components/remootio/translations/*.json`
