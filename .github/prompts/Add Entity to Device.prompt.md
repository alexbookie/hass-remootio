...
- Inherit from `RemootioEntity` and platform base class
...
- Entity: `custom_components/remootio/[platform]/[entity_name].py`
- Platform: `custom_components/remootio/[platform]/__init__.py`
