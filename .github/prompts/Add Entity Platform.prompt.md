...
**Directory:** `custom_components/remootio/[platform]/`
...
```python
"""[Platform] platform for Remootio."""
...
from .[entity_file] import Remootio[EntityName]
from .const import DOMAIN
from .coordinator import RemootioDataUpdateCoordinator
...
async def async_setup_entry(
    ...
    coordinator: RemootioDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            Remootio[EntityName](coordinator, entry),
...
```python
"""[Entity description] for Remootio."""
...
class Remootio[EntityName](
    ...
    def __init__(
        self,
        coordinator: RemootioDataUpdateCoordinator,
        entry: ConfigEntry,
    ) -> None:
...
Add platform to `custom_components/remootio/manifest.json`:
...
- [ ] Entity class inherits from both `RemootioEntity` and platform class
...
- **Base entity:** `RemootioEntity` in `entity/base.py`
- **Coordinator:** `RemootioDataUpdateCoordinator`
