...
- **`entity/`** - Base entity classes (inherit `RemootioEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, RemootioEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import RemootioEntity`
