...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `Remootio`
...
- Inherit from both platform entity and `RemootioEntity` (order matters)
...
from custom_components.remootio.sensor import async_setup_entry
...
**Config entry data:** `entry_data: RemootioData = hass.data[DOMAIN][entry.entry_id]`
