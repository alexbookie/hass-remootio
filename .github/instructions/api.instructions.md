...
- `RemootioApiClientError` (Base)
- `RemootioApiClientCommunicationError` (Network, timeout, HTTP errors)
- `RemootioApiClientAuthenticationError` (401, 403, invalid credentials)
