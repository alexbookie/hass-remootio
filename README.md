...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/alexbookie/hass-remootio?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=hass-remootio&category=integration)
...
1. Download the `custom_components/remootio/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=remootio)
...
Find all entities in **Settings** → **Devices & Services** → **Remootio** → click on the device.
...
```yaml
service: remootio.example_action
data:
  # Add your parameters here
```

### `remootio.reload_data`
...
4. Check the integration diagnostics (Settings → Devices & Services → Remootio → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@alexbookie][user_profile]**
